        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitute = table.Column<float>(type: "real", nullable: true),
                    Longitute = table.Column<float>(type: "real", nullable: true),
                    Date_Create = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Date_Edit = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorySearch", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_HistorySearch_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date_Create = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Date_Edit = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsBlackList = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feedback", x => new { x.UserId, x.FoodId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodEaten", x => new { x.UserId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_FoodEaten_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodEaten_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodOfUser", x => new { x.UserId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_FoodOfUser_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodOfUser_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Report", x => new { x.UserId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_Report_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodEaten_FoodId",
                table: "FoodEaten",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodOfUser_FoodId",
                table: "FoodOfUser",
                column: "FoodId");
