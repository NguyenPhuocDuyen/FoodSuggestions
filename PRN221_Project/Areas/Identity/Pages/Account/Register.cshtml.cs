...
namespace PRN221_Project.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Độ dài mật khẩu ít nhất {2} và nhiều nhất {1} kí tự", MinimumLength = 6)]
            [DataType(DataType.Password, ErrorMessage = "Mật khẩu phải có ít nhất một ký tự không phải chữ và số.\r\nMật khẩu phải có ít nhất một chữ hoa ('A' - 'Z').")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.UserImage = "/images/Avatars/avt.png";
